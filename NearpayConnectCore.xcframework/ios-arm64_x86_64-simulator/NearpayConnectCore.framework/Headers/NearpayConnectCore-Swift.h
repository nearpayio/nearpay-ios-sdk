...
#ifndef NEARPAYCONNECTCORE_SWIFT_H
#define NEARPAYCONNECTCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NearpayConnectCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18NearpayConnectCore12Connectivity") SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface Connectivity (SWIFT_EXTENSION(NearpayConnectCore)) <NSURLSessionWebSocketDelegate>
